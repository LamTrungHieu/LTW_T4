<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <form action="${pageContext.request.contextPath }/admin/category/update" method ="post" enctype="multipart/form-data">
  <input type="text" id="categoryid" name="categoryname" value="${cate.categoryname }" hidden="hidden"><br>
  ...
  <input type="file" onchange="chosseFile(this)" id="images" name="images" value="${cate.images }"><br>
